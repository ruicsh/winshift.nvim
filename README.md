...
require("winshift").setup({
  ...
  after_swap = function(swapped_wins)
    -- Example: Print a message when windows are swapped
    print(string.format("Swapped windows %d and %d", swapped_wins.win1, swapped_wins.win2))
  end,
})
```
